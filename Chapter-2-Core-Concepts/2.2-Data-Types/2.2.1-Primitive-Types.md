...
let a = 42; // [Number]
let b = 3.14; // [Number]
let c = Infinity; // [Number] "Special"
let c2 = 1 / 0; // [Number] Special (Infinity)
let d = -Infinity; // [Number] "Special"
let e = NaN; // [Number] "Special"
let e2 = "Hello" / 2; // [Number] Special (NaN)
let f = "Hello"; // [String]
let f2 = `Hello ${e2}`; // [String]
let g = true; // [Boolean]
let g2 = 4 > 1; // [Boolean] (true)
let h = null; // [Null] "Intentional absence"
console.log(typeof null); // [Object] "typeof operator Bug"
let i = undefined; // [Undefined] “Value is not assigned”.
let j = Symbol("unique"); // [Symbol] "immutable, unique"
let k = 900719925474099112312211n; // [BigInt]
let fn = function () {};
console.log(typeof fn); // Function - But there is no such data type
```
