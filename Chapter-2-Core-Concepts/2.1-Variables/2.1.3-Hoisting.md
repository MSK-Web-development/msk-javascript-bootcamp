...
console.log(b); // ReferenceError
console.log(c); // ReferenceError
console.log(scopeFn); // [Function: scopeFn] [Hoisted]
console.log(insideFn); // ReferenceError
console.log(outsideFn); // ReferenceError

function scopeFn() {
  console.log(a); // undefined [Hoisted]
  console.log(b); // ReferenceError
  console.log(c); // ReferenceError
  console.log(insideFn); // [Function: insideFn] [Hoisted]

  // Temporal Dead Zone (TDZ) for `b` and `c`
