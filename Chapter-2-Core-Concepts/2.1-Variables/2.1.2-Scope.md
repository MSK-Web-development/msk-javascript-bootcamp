...
var a = "global var";
let z = "outer var";
console.log(a); // "global var" [Global scope]
...
function Fn() {
  var b = "function var";
  let z = "inner var";
  console.log(z); // "inner var" [Variable shadowing]
  console.log(a); // "global var" [Lexical scope]
  console.log(b); // "function var" [Function scope]
  console.log(c); // ReferenceError
  console.log(d); // undefined [Hoisting]

  if (true) {
    let c = "block var";
    var d = 100;
    console.log(c); // "block var" [Block scope]
  }

  console.log(i); // ReferenceError
  for (let i = 0; i < 1; i++) {
    console.log(i); // 0 [Block scope]
  }
}
